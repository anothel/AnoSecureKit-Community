...
foreach(_anosecurekit_file IN LISTS _anosecurekit_text_files)
  ...
  if(NOT _anosecurekit_rel STREQUAL "cmake/check_legacy_identifiers.cmake")
    ...
    if(_anosecurekit_lower MATCHES "github\\.com/anothel/anosecurekit([^a-z0-9_-]|$)")
      list(APPEND _anosecurekit_violations "${_anosecurekit_rel}: legacy AnoSecureKit repository URL")
    endif()
  endif()
