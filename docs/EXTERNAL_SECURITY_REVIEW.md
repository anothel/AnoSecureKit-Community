...
Review timing: run after the matching GitHub Release source assets are uploaded,
checksummed, and attested. Package-channel publication can happen separately
from this review.
...
- `tests/fuzz/corpus`
- released `anosecurekit-X.Y.Z-source.tar.gz`
- `SHA256SUMS.txt`
- release SPDX SBOM
...
findings into AnoSecureKit work unless this repository's identity changes first.
