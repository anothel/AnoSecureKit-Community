...
#ifndef ANOSECUREKIT_TEST_FIXTURE_UTILS_HPP_
#define ANOSECUREKIT_TEST_FIXTURE_UTILS_HPP_
...
{
	const std::filesystem::path path = std::filesystem::path(ANOSECUREKIT_TEST_FIXTURE_DIR) / name;
...
#endif // ANOSECUREKIT_TEST_FIXTURE_UTILS_HPP_
